...
//	public
 class Bot extends FlxSprite
	{
//		[Embed(source="../../../data/bot.png")] 
static public var ImgBot:Texture2D;
...
//		[Embed(source="../../../data/jet.mp3")] 
static public var SndJet:AudioClip;
		...
		public function Bot(xPos:int,yPos:int,Bullets:FlxArray,ThePlayer:Player)
		{
			...
			_gibs = FlxG.state.add(new FlxEmitter(0,0,0,0,null,-1.5,-150,150,-200,0,-720,720,400,0,ImgGibs,5,true,null)) as FlxEmitter;
			_jets = FlxG.state.add(new FlxEmitter(0,0,0,0,null,0.01,0,0,0,0,0,0,0,0,ImgJet,5,false,null)) as FlxEmitter;

			reset(x,y);
            // _sprite.SetColor(new Color(0,0,1,1));
		...
		private function shoot():void
		{
			...
			(_b[_cb] as BotBullet).shoot(x+width/2-2,y+height/2-2,ba.x,ba.y);
