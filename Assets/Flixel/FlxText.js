...
//	public
 class FlxText extends FlxBasic
	...
	public function FlxText(X:Number, Y:Number, Width:uint, Height:uint, Text:String, Color:uint/*=0x000000*/) {
		init(X,Y,Width,Height,Text,Color,null,8,null,0);
	}
		public function FlxText(X:Number, Y:Number, Width:uint, Height:uint, Text:String, Color:uint/*=0x000000*/, Font:String/*=null*/, Size:uint/*=8*/) {
			init(X,Y,Width,Height,Text,Color,Font,Size,null,0);
		}
		public function FlxText(X:Number, Y:Number, Width:uint, Height:uint, Text:String, Color:uint/*=0x000000*/, Font:String/*=null*/, Size:uint/*=8*/, Justification:String/*=null*/) {
			init(X,Y,Width,Height,Text,Color,Font,Size,Justification,0);
		}
	public function FlxText(X:Number, Y:Number, Width:uint, Height:uint, Text:String, Color:uint/*=0x000000*/, Font:String/*=null*/, Size:uint/*=8*/, Justification:String/*=null*/, Angle:Number/*=0*/)
	{
	    init(X,Y,Width,Height,Text,Color,Font,Size,Justification,Angle);
    }
		public function init(X:Number, Y:Number, Width:uint, Height:uint, Text:String, Color:uint/*=0x000000*/, Font:String/*=null*/, Size:uint/*=8*/, Justification:String/*=null*/, Angle:Number/*=0*/)
		{
