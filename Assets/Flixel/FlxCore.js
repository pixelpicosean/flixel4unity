...
class FlxBasic
	{
		//@desc	Kind of a global on/off switch for any objects descended from FlxBasic
		...
		//@desc		Checks to see if some FlxBasic object overlaps this FlxBasic object
		//@param	Core	The object being tested
		//@return	Whether or not the two objects overlap
		public function overlaps(Core:FlxBasic):boolean
		{
			var tx:Number = x;
			var ty:Number = y;
